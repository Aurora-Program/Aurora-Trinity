...
- \(DO\), como recorrido orientado y gasto de búsqueda;
- \(O\), como posición o sentido de lectura;
- \(O_U\), como orientación de la salida U construida por una ventana;
...
El diccionario recupera candidatos creados o aprendidos anteriormente. Después, la candidata debe volver a operar dentro de la cara y de la ventana actuales. Solo si la relación completa produce cierre puede reutilizarse y actualizar su prioridad. La salida aceptada conserva como \(O_U\) la orientación \(DO_t\) del intento que consiguió ese cierre.
